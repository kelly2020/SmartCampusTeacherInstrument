 ...
 */
package com.johnson.commonlibs.common_utils.views.pullview.pullutils;
...
public class AbFileUtil {
   ...
   public static void copyAssets2SD(Context context, String assetDir, String outDir) {
	...
	public static void initFileDir(Context context){
		...
		//默认下载文件根目录. 
		String downloadRootPath = File.separator  + path + File.separator + info.packageName + File.separator;
		
	    //默认下载图片文件目录. 
		String imageDownloadPath = downloadRootPath + path + File.separator;
	    
	    //默认下载文件目录.
		String fileDownloadPath = downloadRootPath  + path + File.separator;
		
		//默认缓存目录.
		String cacheDownloadPath = downloadRootPath + path + File.separator;
		
		//默认DB目录.
		String dbDownloadPath = downloadRootPath + path + File.separator;
